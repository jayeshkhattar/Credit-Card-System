...
public class AddCardCompanyJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add New Card Company");
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        if(card.getText().isEmpty() || code.getText().isEmpty() || addre.getText().isEmpty() ||
                user.getText().isEmpty() || pass.getText().isEmpty() ) {
            JOptionPane.showMessageDialog(null, "Fields cannot be left empty");
            return;
        }
        if(ecoSystem.getCardCompanyDirectory().getCardCompanyDirectory() != null && ecoSystem.getCardCompanyDirectory().getCardCompanyDirectory().size() != 0){
        ...
        ecoSystem.getCardCompanyDirectory().newCardCompany(card.getText(),code.getText(),addre.getText());
